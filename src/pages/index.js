    ...
    <Content>
      <div className="row align-center">
        <div className="columns small-12 medium-11 large-10">
          ...
          <p className="text-center">
            Працюємо щоденно, включно неділя та субота. Адже санітарно-технічні
            комунікації є обов’язковим елементом будь-якого житлового, або
            виробничого приміщення. Їх потрібно постійно підтримувати у
            функціональному стані. Наші майстри забезпечують це. Вони завжди
            готові виїхати на виклик.
          </p>
      ...
      <div className="row align-center">
        <div className="columns small-12 medium-8 large-8">
          ...
          <h3>
            <span className="show-for-sr">Послуги сантехніка у Львові · </span>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  ...
                  (багатоповерхівках та приватних будинках, закладах харчування,
                  на виробництвах)
                </td>
              </tr>
              <tr>
          ...
          <table className="text-small hover">
            <tbody>
              ...
              <tr>
                <td>
                  попередній виїзд на об'єкт кваліфікованого працівника, оцінка
                  та консультація
                </td>
              </tr>
              <tr>
                <td>
                  балкон, тераса: очистка та грунтування поверхні грунтом TG-2,
                  наклеювання ізоляційної стрічки по примиканню за допомогою
                  weber.tec 822, нанесення weber.tec 822 у два шари{" "}
                </td>
              </tr>
              <tr>
                <td>
      ...
      <div className="row align-center">
        <div className="columns small-12 medium-11 large-10">
          ...
          <p className="text-center">
            ...
            який день, котру годину). При необхідності залучається бригада наших
            співробітників. Фахівець, який надає послуги сантехніка Львів має
            високий рівень підготовки, багаторічний практичний досвід виконання
            сантехнічних робіт. На його озброєнні професійний сучасний
            інструмент. Kran.lviv застосовує демократичні розцінки на послуги
            сантехніка. Вони максимально доступні для всіх верств населення.
            Залежать від складності та умов виконання сантехнічних робіт. Існує
            система знижок, акційні пропозиції.
          </p>
